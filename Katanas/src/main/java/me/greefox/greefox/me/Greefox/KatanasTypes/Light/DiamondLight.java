...
public class DiamondLight extends JavaPlugin {
    ...
    private static void createLightDiamondKatana() {
        ...
        SmithingTransformRecipe smtr = new SmithingTransformRecipe(NamespacedKey.minecraft("netherite_katana_light"), item, new RecipeChoice.MaterialChoice(Material.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                new RecipeChoice.ExactChoice(lightDiamondKatana), new RecipeChoice.MaterialChoice(Material.NETHERITE_INGOT));
        try {
            Bukkit.addRecipe(sr);
